...
<Accordion title="Who is dBocl for?">
...
<Accordion title="How does dBocl simplify event management?">
...
<Accordion title="Can I manage multiple events at once?">
...
<Accordion title="Is dBocl suitable for large-scale productions?">
...
<Accordion title="Can I try dBocl for free?">
...
<Accordion title="What tabs are available on a person's profile?">
...
<Accordion title="How does the status system work for people?">
...
<Accordion title="How does the tagging system work for people?">
...
<Accordion title="How can I import or export people data?">
...
<Accordion title="What are the main view modes for the Schedule page?">
...
<Accordion title="What information is displayed for each item in Calendar View?">
...
<Accordion title="What information is shown for each item in List View?">
  Each row contains:
  - Time
  - Title
  - Location
...
<Accordion title="What information can I include when creating a schedule item?">
...
<Accordion title="How do I generate reports from the Schedule page?">
...
<Accordion title="What interactive features does the Schedule page offer?">
...
<Accordion title="How do I access the Files page?">
...
<Accordion title="What view modes are available for files?">
...
<Accordion title="How are files organized in the system?">
...
<Accordion title="How do I upload files to the system?">
  Upload via:
  - Drag-and-drop area
  - File selector
...
<Accordion title="What does the file detail view show?">
...
<Accordion title="How do permissions work for files?">
...
<Accordion title="How does file versioning work?">
...
<Accordion title="How do I access the Tasks page?">
...
<Accordion title="What view modes are available for tasks?">
...
<Accordion title="What information is shown for each task in the list?">
...
<Accordion title="What actions are available in the task hover menu?">
...
<Accordion title="What information can I include when creating a task?">
  Task fields include:
...
<Accordion title="How do milestones work with tasks?">
...
<Accordion title="What task relationships are supported?">
...
<Accordion title="How do I access the Travel page?">
...
<Accordion title="What view modes are available for travel information?">
...
<Accordion title="What information is shown in the Manifest View?">
...
<Accordion title="What information can I include when creating a travel entry?">
...
<Accordion title="How does lodging information work in the system?">
...
<Accordion title="How can I duplicate travel arrangements for multiple people?">
...
<Accordion title="What types of reports can I generate?">
  dBocl offers comprehensive reporting capabilities across all modules:
  - Schedule reports (itineraries, call sheets, daily schedules)
  - People reports (contact lists, status reports, team rosters)
  - Task reports (progress reports, completion status, assignment overviews)
  - Travel manifests (arrival/departure lists, accommodation details)
  - File documentation (inventory lists, access logs)
  - Cross-platform exports (PDF, CSV, Excel formats)
</Accordion>

<Accordion title="How do I customize report content?">
...
<Accordion title="Can I schedule automated reports?">
  Yes, you can set up automated report generation and distribution:
